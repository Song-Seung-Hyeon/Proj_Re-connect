    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (filePart != null && filePart.getSize() > 0) {
                ...
                String query = "INSERT INTO contact_answer (answer_writer, answer_title, answer_content, photo_url, answer_reg_date) VALUES (?, ?, ?, ?, now())";
                ...
                String query = "INSERT INTO contact_answer (answer_writer, answer_title, answer_content, answer_reg_date) VALUES (?, ?, ?, now())";
                pstmt = conn.prepareStatement(query);
            ...
            response.sendRedirect("post_management.jsp");
