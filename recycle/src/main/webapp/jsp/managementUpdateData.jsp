...
System.out.println(user_uid+":"+user_id+user_pw+user_name+user_phone+user_email+user_auth);
...
try {
	...
	// 쿼리 작성
	String sql = "UPDATE user_list SET user_id=?, user_pw=?, user_name=?, user_phone=?, user_email=?, user_auth=? WHERE user_uid=?";
	...
	preparedStatement.setString(7, user_uid);
