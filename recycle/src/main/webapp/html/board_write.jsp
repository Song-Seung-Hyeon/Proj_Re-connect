...
<body>
	...
	<main>
		...
		<div class="board_wrap">
			...
			<form action="UploadBoardServlet" method="post"	enctype="multipart/form-data">
				<table class="view">
					<thead>
						<tr>
							<th colspan="8" class="title"><input type="text" name="board_title" placeholder="제목을 입력해주세요." required>
</th>
						</tr>
					</thead>
					<tbody>
						<tr class="info">
							...
							<th>비밀번호</th>
							<td><input type="password" name="board_pw"
								placeholder="비밀번호를 입력해주세요" required maxlength="4"></td>
						</tr>
						<tr>
