    ...
    for (let s = 1; s < arguments.length; s += 1) {
        ...
        if (null != i && !c(i)) {
            ...
            for (let t = 0, a = s.length; t < a; t += 1) {
                ...
                void 0 !== r && r.enumerable && (d(e[a]) && d(i[a]) ? i[a].__swiper__ ? e[a] = i[a] : p(e[a], i[a]) : !d(e[a]) && d(i[a]) ? (e[a] = {}, i[a].__swiper__ ? e[a] = i[a] : p(e[a], i[a])) : e[a] = i[a])
            }
        }
    }
    return e
...
function E(e) {
    return void 0 === e && (e = {}), S || (S = function(e) {
        ...
        const u = n.match(/(iPod)(.*OS\s([\d_]+))?/),
            ...
            f = "Win32" === a;
        let h = "MacIntel" === a;
        return !p && h && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${d}`) >= 0 && (p = n.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), h = !1), c && !f && (l.os = "android", l.android = !0), (p || m || u) && (l.os = "ios", l.ios = !0), l
    }(e)), S
}
    ...
    P = e => {
        ...
        if (e.params.rewind || e.params.loop)
            for (let n = a - t; n <= r + t; n += 1) {
                ...
                for (let n = Math.max(a - t, 0); n <= Math.min(r + t, s - 1); n += 1) n !== a && (n > r || n < a) && L(e, n)
    };
...
function O(e) {
    ...
    Object.assign(n, {
        ...
        isScrolling: void 0,
        startMoving: void 0
    }), d.startX = g, d.startY = b, n.touchStartTime = l(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (n.allowThresholdMove = !1);
    let S = !0;
...
function I(e) {
    ...
    if (void 0 === a.isScrolling) {
        let e;
        s.isHorizontal() && n.currentY === n.startY || s.isVertical() && n.currentX === n.startX ? a.isScrolling = !1 : h * h + v * v >= 25 && (e = 180 * Math.atan2(Math.abs(v), Math.abs(h)) / Math.PI, a.isScrolling = s.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle)
    }
    ...
    r.oneWayMovement && (g = Math.abs(g) * (o ? 1 : -1), b = Math.abs(b) * (o ? 1 : -1)), n.diff = g, g *= r.touchRatio, o && (g = -g, b = -b);
    ...
    a.isMoved && w !== s.touchesDirection && y && Math.abs(g) >= 1 && (s.loopFix({
        direction: s.swipeDirection,
        setTranslate: !0
    }), S = !0), s.emit("sliderMove", c), a.isMoved = !0, a.currentTranslate = g + a.startTranslate;
    let T = !0,
        x = r.resistanceRatio;
    if (r.touchReleaseOnEdges && (x = 0), g > 0 ? (y && !S && a.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }), a.currentTranslate > s.minTranslate() && (T = !1, r.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** x))) : g < 0 && (y && !S && a.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
            direction: "next",
            setTranslate: !0,
...
function A(e) {
    ...
    for (let n = 0; n < d.length; n += n < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
        ...
        void 0 !== d[n + e] ? f >= d[n] && f < d[n + e] && (h = n, v = d[n + e] - d[n]) : f >= d[n] && (h = n, v = d[d.length - 1] - d[d.length - 2])
    }
    let g = null,
        b = null;
    ...
    if (m > a.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (w >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? g : h + y) : t.slideTo(h)), "prev" === t.swipeDirection && (w > 1 - a.longSwipesRatio ? t.slideTo(h + y) : null !== b && w < 0 && Math.abs(w) > a.longSwipesRatio ? t.slideTo(b) : t.slideTo(h))
    } else {
        if (!a.shortSwipes) return void t.slideTo(t.activeIndex);
        t.navigation && (p.target === t.navigation.nextEl || p.target === t.navigation.prevEl) ? p.target === t.navigation.nextEl ? t.slideTo(h + y) : t.slideTo(h) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : h + y), "prev" === t.swipeDirection && t.slideTo(null !== b ? b : h))
    }
}
...
const F = (e, t) => {
    ...
    r[d]("pointerdown", e.onTouchStart, {
        ...
        passive: !0
    }), (a.preventClicks || a.preventClicksPropagation) && r[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", z, !0) : e[c]("observerUpdate", z, !0), r[d]("load", e.onLoad, {
        capture: !0
    })
};
...
const j = {
        ...
        update: {
            ...
            updateSlides: function() {
                ...
                for (let u = 0; u < m; u += 1) {
                    let a;
                    if (k = 0, p[u] && (a = p[u]), P && e.grid.updateSlide(u, a, m, t), !p[u] || "none" !== v(a, "display")) {
                        if ("auto" === i.slidesPerView) {
                            O && (p[u].style[t("width")] = "");
                            const r = getComputedStyle(a),
                                n = a.style.transform,
                                l = a.style.webkitTransform;
                            if (n && (a.style.transform = "none"), l && (a.style.webkitTransform = "none"), i.roundLengths) k = e.isHorizontal() ? w(a, "width", !0) : w(a, "height", !0);
                            else {
                                const e = s(r, "width"),
                                    t = s(r, "padding-left"),
                                    i = s(r, "padding-right"),
                            ...
                            n && (a.style.transform = n), l && (a.style.webkitTransform = l), i.roundLengths && (k = Math.floor(k))
                        } else k = (n - (i.slidesPerView - 1) * E) / i.slidesPerView, i.roundLengths && (k = Math.floor(k)), p[u] && (p[u].style[t("width")] = `${k}px`);
                        p[u] && (p[u].swiperSlideSize = k), b.push(k), i.centeredSlides ? (C = C + k / 2 + M / 2 + E, 0 === M && 0 !== u && (C = C - n / 2 - E), 0 === u && (C = C - n / 2 - E), Math.abs(C) < .001 && (C = 0), i.roundLengths && (C = Math.floor(C)), L % i.slidesPerGroup == 0 && h.push(C), g.push(C)) : (i.roundLengths && (C = Math.floor(C)), (L - Math.min(e.params.slidesPerGroupSkip, L)) % e.params.slidesPerGroup == 0 && h.push(C), g.push(C), C = C + k + E), e.virtualSize += k + E, M = k, L += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, n) + S, l && o && ("slide" === i.effect || "coverflow" === i.effect) && (a.style.width = `${e.virtualSize + E}px`), i.setWrapperSize && (a.style[t("width")] = `${e.virtualSize + E}px`), P && e.grid.updateWrapperSize(k, h, t), !i.centeredSlides) {
                    const t = [];
                ...
                if (Object.assign(e, {
                    ...
                    u(a, "--swiper-centered-offset-before", -h[0] + "px"), u(a, "--swiper-centered-offset-after", e.size / 2 - b[b.length - 1] / 2 + "px");
                    const t = -e.snapGrid[0],
                        s = -e.slidesGrid[0];
                    e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
                }
                if (m !== c && e.emit("slidesLengthChange"), h.length !== T && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), g.length !== x && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), !(d || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
            ...
            updateSlidesProgress: function(e) {
                ...
                for (let o = 0; o < i.length; o += 1) {
                    ...
                    (u >= 0 && u < t.size - 1 || m > 1 && m <= t.size || u <= 0 && m >= t.size) && (t.visibleSlides.push(e), t.visibleSlidesIndexes.push(o), i[o].classList.add(s.slideVisibleClass)), e.progress = a ? -c : c, e.originalProgress = a ? -p : p
                }
            },
            ...
            updateActiveIndex: function(e) {
                ...
                p = t.virtual && a.virtual.enabled && a.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d, Object.assign(t, {
                    ...
                    previousIndex: r,
                    activeIndex: d
                }), t.initialized && P(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), n !== p && t.emit("realIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && t.emit("slideChange")
            },
        ...
        slide: {
            slideTo: function(e, t, s, i, a) {
                ...
                let w;
                if (n !== (c || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(b), w = n > p ? "next" : n < p ? "prev" : "reset", u && -b === r.translate || !u && b === r.translate) return r.updateActiveIndex(n), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== l.effect && r.setTranslate(b), "reset" !== w && (r.transitionStart(s, w), r.transitionEnd(s, w)), !1;
                if (l.cssMode) {
                    const e = r.isHorizontal(),
                        s = u ? b : -b;
                    if (0 === t) {
                ...
                return r.setTransition(t), r.setTranslate(b), r.updateActiveIndex(n), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, i), r.transitionStart(s, w), 0 === t ? r.transitionEnd(s, w) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(e) {
                ...
                if (y && v.forEach((e => {
                    ...
                    if (v.length > 0 && y)
                        if (void 0 === t) {
                            ...
                            l ? o.setTranslate(o.translate - t) : (o.slideTo(b + S, 0, !1, !0), a && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
                        } else a && o.slideToLoop(t, 0, !1, !0);
                else if (g.length > 0 && w)
                    if (void 0 === t) {
                        const e = o.slidesGrid[b],
                            t = o.slidesGrid[b - T] - e;
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(b - T, 0, !1, !0), a && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = O.bind(e), e.onTouchMove = I.bind(e), e.onTouchEnd = A.bind(e), s.cssMode && (e.onScroll = D.bind(e)), e.onClick = G.bind(e), e.onLoad = $.bind(e), _ || (t.addEventListener("touchstart", B), _ = !0), F(e, "on")
            },
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                }), c && !f ? e.disable() : !c && f && e.enable(), e.currentBreakpoint = n, e.emit("_beforeBreakpoint", l), m && s && (e.loopDestroy(), e.loopCreate(t), e.updateSlides()), e.emit("breakpoint", l)
            },
...
class q {
    constructor() {
        ...
        const l = this;
        l.__swiper__ = !0, l.support = x(), l.device = E({
        ...
        const d = p({}, H, o);
        return l.params = p({}, d, R, t), l.originalParams = p({}, l.params), l.passedParams = p({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach((e => {
    ...
    getSlideIndex(e) {
        const {
            slidesEl: t,
            params: s
        } = this, i = g(f(t, `.${s.slideClass}, swiper-slide`)[0]);
        return g(e) - i
    }
    ...
    mount(e) {
        ...
        return !a && t.params.createElements && (a = h("div", t.params.wrapperClass), s.append(a), f(s, `.${t.params.slideClass}`).forEach((e => {
            a.append(e)
        }))), Object.assign(t, {
            el: s,
            wrapperEl: a,
...
function U(e) {
    ...
    function u() {
        ...
        if (t.params.loop ? (r = t.previousRealIndex || 0, i = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (i = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, i = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
            ...
            let o, d, u;
            if (s.dynamicBullets && (n = w(a[0], t.isHorizontal() ? "width" : "height", !0), p.forEach((e => {
        ...
        p.forEach(((e, r) => {
            if ("fraction" === s.type && (e.querySelectorAll(Y(s.currentClass)).forEach((e => {
                ...
                let n = 1,
                    l = 1;
                "horizontal" === a ? n = r : l = r, e.querySelectorAll(Y(s.progressbarFillClass)).forEach((e => {
    ...
    function m() {
        ...
        "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), t.pagination.bullets = [], i.forEach((s => {
            "custom" !== e.type && (s.innerHTML = r || ""), "bullets" === e.type && t.pagination.bullets.push(...s.querySelectorAll(Y(e.bulletClass)))
...
function K(e) {
    ...
    let d, c, p, u, m, f, h, v = o && o.autoplay ? o.autoplay.delay : 3e3,
        g = o && o.autoplay ? o.autoplay.delay : 3e3,
        b = (new Date).getTime;

    function w(e) {
        a && !a.destroyed && a.wrapperEl && e.target === a.wrapperEl && (a.wrapperEl.removeEventListener("transitionend", w), C())
    }
    const y = () => {
        ...
        S = e => {
            ...
            !Number.isNaN(r) && r > 0 && void 0 === e && (i = r, v = r, g = r), d = i;
        ...
        C = () => {
            a.isEnd && d < 0 && !a.params.loop || a.destroyed || !a.autoplay.running || (b = (new Date).getTime(), h ? (h = !1, S(d)) : S(), a.autoplay.paused = !1, l("autoplayResume"))
        },
        M = () => {
            if (a.destroyed || !a.autoplay.running) return;
            const e = i();
            "hidden" === e.visibilityState && (h = !0, E(!0)), "visible" === e.visibilityState && C()
        },
        L = e => {
    ...
    n("init", (() => {
        a.params.autoplay.enabled && (a.params.autoplay.pauseOnMouseEnter && (a.el.addEventListener("pointerenter", L), a.el.addEventListener("pointerleave", P)), i().addEventListener("visibilitychange", M), b = (new Date).getTime(), T())
    })), n("destroy", (() => {
        a.el.removeEventListener("pointerenter", L), a.el.removeEventListener("pointerleave", P), i().removeEventListener("visibilitychange", M), a.autoplay.running && x()
    })), n("beforeTransitionStart", ((e, t, s) => {
        !a.destroyed && a.autoplay.running && (s || !a.params.autoplay.disableOnInteraction ? E(!0, !0) : x())
    })), n("sliderFirstMove", (() => {
        !a.destroyed && a.autoplay.running && (a.params.autoplay.disableOnInteraction ? x() : (p = !0, u = !1, h = !1, m = setTimeout((() => {
            h = !0, u = !0, E(!0)
        }), 200)))
    })), n("touchEnd", (() => {
