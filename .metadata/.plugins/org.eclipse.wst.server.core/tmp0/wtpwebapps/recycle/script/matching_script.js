import { S as e, A as r, N as s, P as t } from "./matcing_script2.js";
!function () {
  const e = document.createElement("link").relList; if (!(e && e.supports && e.supports("modulepreload"))) {
    ...
    new MutationObserver((e => { for (const s of e) if ("childList" === s.type) for (const e of s.addedNodes) "LINK" === e.tagName && "modulepreload" === e.rel && r(e) })).observe(document, { childList: !0, subtree: !0 })
  } function r(e) {
    if (e.ep) return;
    e.ep = !0;
    const r = function (e) {
  ...
  modules: [r, s, t, function ({ swiper: e, on: r }) {
    r("beforeInit", (() => {
      ...
      if ("carousel" === e.params.effect) for (let t = 0; t < e.slides.length; t += 1) {
        const r = e.slides[t], o = r.querySelectorAll(".swiper-carousel-animate-opacity");
        r.style.transitionDuration = `${s}ms`, o.forEach((e => { e.style.transitionDuration = `${s}ms` }))
      }
    }))
  }], effect: "carousel", grabCursor: !0, loop: !0, slidesPerView: "auto", navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" }, pagination: { el: ".swiper-pagination" },
  // autoplay: { delay: 3e3 } 
});
