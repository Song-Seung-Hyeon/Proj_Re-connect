...
String imageName1 = (String) request.getAttribute("imageName");
...
<head>
  ...
  <link rel="stylesheet" href="../CSS/authored_content_view.css" />
  ...
  <header class="account_header">
    ...
    <div class="member">
      <button type="button" class="btn_member">
        <div class="user_photo">
          <figure class="user_img">
            <img src="<%=request.getContextPath()%>/images/<%=imageName1%>" alt="user_img" />
          </figure>
        </div>
      </button>
      ...
      <div class="layer_member">
        <ul>
          <li>
            <img src="<%=request.getContextPath()%>/images/<%=imageName1%>" /><span><%= userName %></span>
            <!-- 유저이미지, 이름 입력 -->
          </li>
          <li>
          ...
          <h1>내가 작성한 글</h1>
			...
			<table class="view">
				...
				<tbody>
					...
					<tr>
						<td colspan="8" class="content2"><textarea id="textarea"	oninput="autoResize()" readonly><%=resultSet.getString("contact_content")%></textarea></td>
					</tr>
					<tr>
					    <%
					    ...
					    %>
					        <td colspan="8" class="content2">
					            <img src="<%=request.getContextPath()%>/images/<%=imageName%>" alt="게시글 이미지" class="boardImg" />
					        </td>
					    <%
					    }
					    %>
			...
			<table class="view2">
				<tbody>
					<tr class="info">
						<th>답변자</th>
						<td><%=resultSet2.getString("user_name")%></td>
						<th>작성일</th>
						<td><%=formatAnswerDate%></td>
					</tr>
					<tr>
						<td colspan="8" class="content3"><textarea id="textarea"
								oninput="autoResize()" readonly><%=resultSet2.getString("answer_content")%></textarea></td>
					</tr>
					<tr>
						<%
					    ...
					    %>
						<td colspan="8" class="content3"><img
			...
			<!--CSS 수정해라 송승현  -->
			<div class="btn_box">
				<a href="authored_content_correction.jsp?uid=<%=uid%>" class="btn_correction">수정</a>
				<a href="authored_content.jsp" class="btn_back">목록</a>
			</div>
        </div>
      </div>
  </main>
    ...
    <footer class="footer">
      <div class="footer-content">
        ...
        <ul class="footer-socials">
          <li>
            <a href="index_logout.jsp"><img src="../images/ico_/image.svg" alt="ico_../image" /></a>
            <!-- 임시로 로그아웃 넣어 놨음 -->
          </li>
          <li>
