			...
			<table class="board_list_wrap">
				...
				<tbody>
					...
					<tr>
						...
						<td class="title"><a
							href="notice_view.jsp?uid=<%=resultSet.getString("uid")%>"><%=resultSet.getString("notice_title")%></a></td>
						<td class="writer"><%=resultSet.getString("notice_writer")%></td>
						<td class="date"><%=formatNoticeDate%></td>
						<td class="count"><%=resultSet.getString("notice_views")%></td>
					</tr>
					<%
					}
					resultSet.close();
