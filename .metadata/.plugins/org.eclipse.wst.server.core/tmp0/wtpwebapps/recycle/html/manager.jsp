...
<head>
	<title>커플매니저소개 | 마음을 다시 연결하는 결혼 정보 플랫폼 DASH</title>
	<meta charset="UTF-8" />
...
<body>
	...
	<main>
		...
		<div class="manager_wrap">
			...
			<div class="sub-title">
				<h5>고객님들의 사랑을 이루어드릴 DASH 매니저입니다.</h5>
			</div>
			...
			<section class="area_1">
				...
				<div class="wrapper">
					...
					<div class="icon arrow"><img src="../images/love_icon2.svg"></img></div>
					<div class="Minjeong">안영태</div>
					<div class="about">커플매니저</div>
					<div class="social-icons">
						<a href="#" class="call"><img src="../images/call.png" /></a>
						<a href="#" class="bookmark"><img src="../images/bookmark.png" /></a>
					</div>
